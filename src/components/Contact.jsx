  ...
  useEffect(() => {
    ...
    img.onload = () => {
      try {
        ...
        // globalDist didefinisikan sekali, di luar loop — aman dipanggil dari mana saja
        const globalDist = (i) => {
        ...
        // seed didefinisikan sekali, di luar loop — dipanggil (bukan dideklarasikan) di dalam loop
        const seed = (i) => {
        ...
        // jarak absolut ke warna referensi global — pengaman anti-"bocor"
        while (qHead < qTail) {
          const i = queue[qHead++];
          const x = i % width;
          const y = (i - x) / width;
          ...
          <div className="absolute inset-0 flex items-end justify-center pb-6 lg:pb-8">
            <div className="relative w-full flex flex-col items-center justify-end">
              <div className="relative w-[260px] h-[340px] sm:w-[300px] sm:h-[380px] lg:w-[320px] lg:h-[420px]">
                ...
                {/* Corner brackets: aksen garis sudut khas UI teknis */}
