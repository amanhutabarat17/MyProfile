      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="flex flex-col gap-6">
            ...
            {[
              { icon: "✉️", label: "Email",    value: "hutabarataman21@gmail.com" },
              { icon: "🐙", label: "GitHub",   value: "github.com/amanhutabarat17" },
              { icon: "💼", label: "LinkedIn", value: "linkedin.com/in/aman-haggai-hutabarat-2ab6b1298" },
              { icon: "📍", label: "Lokasi",   value: "Tarutung, Sumatera Utara" },
              { icon: "📞", label: "Phone",    value: "082375448129" },
            ].map((item, i) => (
